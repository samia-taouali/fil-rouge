    ...
    <div class="main h-100">
        ...
        <div class="details d-flex flex-row bd-highlight mb-2 h-100">
            <div class="section1 col-md-2 float-start h-100">
                ...
                <div class="list">
                    <div><p>Mes informations</p></div>
                    <div><p>Mes commandes</p></div>
                   <div> <p>Commandes en cours</p></div>
                    <div><p>Commandes passé</p></div>
                </div>
            </div>
            <div class="section2 col-md-8">
            <div class="title">
                ...
                <form action="">
                    <div class="inputs">
                        ...
                        <div class="btn"> <input type="submit" value="Modifier"></div>
                    </div>
                </form>
            </div>
        </div>
