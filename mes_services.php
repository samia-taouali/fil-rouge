    ...
    <div class="main">
        ...
        <div class="button">
            <form action="" method="post">
                <input type="button" value="Ajouter un service">
            </form>
        </div>
            ...
            <div id="carouselExample" class="carousel slide col-md-4 ">
                <div class="carousel-inner">
                    <div class=" images carousel-item active">
                        <img src="imgs/photo2.svg" class="d-block w-80 h-80 " alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="imgs/confiture1.png" class="d-block w-80 h-80" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="imgs/confiture2.png" class="d-block w-80 h-80" alt="...">
                    </div>
                </div>
            ...
            <div class="part2 col-md-3">
                ...
                <div class="paragraph">
                    <p>La confiture faite maison est un véritable délice. Préparée avec amour et patience, elle est
                        ...
                        douce concoction sucrée Chaque bouchée révèle l'éclat naturel des fruits <br>
                        , tandis que l'arôme envoûtant emplit la pièce. Une confiture faite maison est bien plus qu'une
                        simple étendue sucrée,<br>
