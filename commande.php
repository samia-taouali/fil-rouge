    ...
    <div class="main">
        <nav class="nav">
            ...
            <div class="icons">
                ...
                <div class="title"> <h1>Effectuer votre commande</h1></div>
                <div class="section1">
                    <div class="part1"><p>Effectuer votre commande</p></div>
                    <form action="" method="post" class="form">
                        <div class="inputs">
                            ...
                            <div class="input1">
                                ...
                                <textarea name=""  cols="30" rows="10" placeholder=" déscription"></textarea>
                                <div class="btn"> <input type="submit" value="Se connecter"></div>
                            </div>
                        </div>
                    </form>
                </div>
